...
import { ModeloModel } from "@/types"; // Cambiado a ModeloModel

interface ModelosListProps extends ModeloModel {
    fetcher: () => void;
}

const ModelosList: React.FC<ModelosListProps> = (params) => {
    const { data: session, status } = useSession();
    const [showConfirmModal, setShowConfirmModal] = useState<boolean>(false);
    const [modeloIdToDelete, setModeloIdToDelete] = useState<number | null>(null);
